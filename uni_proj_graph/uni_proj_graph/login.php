...
<div class="wrapper-frame">
    ...
    <div class="wrapper-row" style="min-height: 60vh; display: flex; align-items: center; justify-content: center;">
        <section class="container" style="max-width: 400px; width: 100%; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); padding: 2em;">
            <h2 style="text-align:center; color:#2BA8BD; margin-bottom: 1em;">Login to Your Account</h2>
            <form id="loginForm">
                ...
                <button type="submit" style="width:100%; background-color:#2BA8BD; color:white; padding:0.75em; border:none; border-radius:5px; font-size:1em; cursor:pointer;">Login</button>
            </form>
            <p style="text-align:center; margin-top:1.5em;">Don't have an account? <a href="signup.php" style="color:#2BA8BD; text-decoration:underline;">Signup here</a>.</p>
        </section>
    </div>
    <footer id="footer">
		<div class="bottom">
