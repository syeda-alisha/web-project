        ...
        <section class="container">
            <div style="background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.07); padding: 2em; margin-bottom: 2em;">
                ...
                <div style="text-align:center; margin-bottom: 1em;">
                    <?php
                    $profile_picture = isset($_SESSION['user_picture']) && $_SESSION['user_picture'] ? 'picture/' . $_SESSION['user_picture'] : 'images/default-profile.png';
                    ?>
                    <img src="<?php echo htmlspecialchars($profile_picture); ?>" alt="Profile Picture" style="width:100px; height:100px; object-fit:cover; border-radius:50%; border:2px solid #2BA8BD; background:#f8f9fa;">
                </div>
